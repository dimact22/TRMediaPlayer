	...
	public:
		MyForm(void)
		{
			...
			if (System::IO::File::ReadAllText("last_video.txt") != "" && System::Convert::ToInt32(a[4]) > 1)
			{
				...
				{
					auto t = System::IO::File::ReadAllLines("last_video.txt");
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(747, 446);
			...
			this->trackBar3->Location = System::Drawing::Point(55, 372);
			this->trackBar3->Maximum = 100;
			this->trackBar3->Name = L"trackBar3";
			this->trackBar3->Size = System::Drawing::Size(693, 24);
			...
			this->panel3->Location = System::Drawing::Point(0, 393);
			this->panel3->Name = L"panel3";
			this->panel3->Size = System::Drawing::Size(747, 53);
			...
			this->panel7->Size = System::Drawing::Size(36, 34);
			...
			this->label2->Location = System::Drawing::Point(509, 10);
			...
			this->panel5->Size = System::Drawing::Size(36, 33);
			...
			this->trackBar1->Size = System::Drawing::Size(133, 19);
			...
			this->panel4->Size = System::Drawing::Size(40, 33);
			...
			this->panel2->Margin = System::Windows::Forms::Padding(0, 3, 3, 30);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(748, 353);
			...
			this->axWindowsMediaPlayer1->Size = System::Drawing::Size(748, 353);
			...
			this->menuStrip2->Size = System::Drawing::Size(747, 24);
...
private: System::Void MyForm_FormClosed(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e) {
	System::IO::File::WriteAllText("last_video.txt", System::Convert::ToString(trackBar1->Value));
	System::IO::File::AppendAllText("last_video.txt", "\n");
	System::IO::File::AppendAllText("last_video.txt", System::Convert::ToString(axWindowsMediaPlayer1->settings->rate));
	System::IO::File::AppendAllText("last_video.txt", "\n");
	if (label2->Text == "Героям слава!")
	{
		System::IO::File::AppendAllText("last_video.txt", System::Convert::ToString(0));
	}
	else
	{
		System::IO::File::AppendAllText("last_video.txt", System::Convert::ToString(1));
	}
	System::IO::File::AppendAllText("last_video.txt", "\n");
	System::IO::File::AppendAllText("last_video.txt", axWindowsMediaPlayer1->URL);
	System::IO::File::AppendAllText("last_video.txt", "\n");
	System::IO::File::AppendAllText("last_video.txt", System::Convert::ToString(trackBar3->Value));
